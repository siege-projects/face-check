 ...
 */
public class UserRegisterActvity extends BaseActivity {
	...
	private void zcRl() {
		...
		Params params = Params.getInstance("https://aip.baidubce.com/rest/2.0/face/v3/faceset/user/add");
